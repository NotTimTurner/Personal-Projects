...
/// <summary>
/// Origional concept for my wallpaper project, you would choose which folder to drop them into( out of 2 choices) 
/// after running it the first time i realized i could automate the entire thing, so this was abandoned 
/// </summary>
